...
exports.compoundExpand = (value, { rowIndex, columnIndex, rowData, column, property }) => {
    ...
    return {
        ...
        children: props.isOpen !== undefined && (React.createElement("button", { className: react_styles_1.css(table_1.default.tableButton), onClick: onToggle, "aria-expanded": props.isOpen, "aria-controls": props.ariaControls },
