...
declare const emptyTD: ITransform;
declare const scopeColTransformer: ITransform;
declare const emptyCol: ITransform;
declare const parentId: ITransform;
declare const mapProps: ITransform;
