...
private static class Node<T>{ 
	/* in this class we put links on object
	 * 2 links at object: link at previous and link at next
	 */
	public T obj;
	public Node<T> next;
	public Node<T> prev;
...
public  IndexedLinkedList(int dummy) {  //nothing
	// TODO Auto-generated constructor stub
}

/*
 * // TODO Добавить по индексу и удалить по индекуу
 *  write methods add(int index, T obj) and remove(int index).
 *  Make sure that the appropriate tests pass
 * 
 * 
 */
	@Override
